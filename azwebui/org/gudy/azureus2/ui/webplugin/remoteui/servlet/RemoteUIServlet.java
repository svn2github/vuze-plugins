	...
	extends WebPlugin
{
	...
	static String[] resource_names = {
		...
		"core3/util/protocol/AzURLStreamHandlerFactory.class",
		...
		"plugins/PluginState.class",
		"plugins/config/ConfigParameter.class",
		"plugins/config/PluginConfigSource.class",
		"plugins/ipc/IPCInterface.class",
		...
		"plugins/download/DownloadStub.class",
		"plugins/download/DownloadStubListener.class",
		"plugins/download/DownloadStubEvent.class",
		...
		"plugins/download/savelocation/SaveLocationManager.class",
		"plugins/download/savelocation/DefaultSaveLocationManager.class",
