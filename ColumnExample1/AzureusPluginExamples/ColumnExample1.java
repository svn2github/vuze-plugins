	...
	implements Plugin
{
	...
	public void initialize(PluginInterface pluginInterface) {
		...
		sampleColumn = tableManager.createColumn(
				TableManager.TABLE_MYTORRENTS_COMPLETE, COLUMNID_TORRENTDATE);
		...
		sampleColumn = tableManager.createColumn(
				TableManager.TABLE_MYTORRENTS_INCOMPLETE, COLUMNID_TORRENTDATE);
		sampleColumn.initialize(TableColumn.ALIGN_LEAD, TableColumn.POSITION_LAST,
				150);
		...
		sampleColumn.initialize(TableColumn.ALIGN_TRAIL, TableColumn.POSITION_LAST,
				150, TableColumn.INTERVAL_LIVE);
	 ...
	 */
	public class CreationDateRefreshListener
		implements TableCellRefreshListener
	{
		...
		public void refresh(TableCell cell) {
			...
			// Data Source can be null or even a different object.  We are only
			...
			// There is no guarantee a Download has a torrent object
			if (torrent == null) {
				return;
			}
			long torrentDate = torrent.getCreationDate();
	...
	public class PercentRemainingRefreshListener
		implements TableCellRefreshListener
	{
