	...
	implements CheckerListener
{
			...
			public void pressed(SWTSkinButtonUtility buttonUtility,
				...
				Utils.getOffOfSWTThread(new AERunnable() {
					...
					public void runSupport() {
						PluginAir.instance.checker.calcProtocolAddresses();
		...
		soPFButton.addSelectionListener(new ButtonListenerAdapter() {
			...
			public void pressed(SWTSkinButtonUtility buttonUtility,
				...
				Utils.getOffOfSWTThread(new AERunnable() {
					@Override
					public void runSupport() {
						PluginAir.instance.checker.portBindingCheck();
					}
				});
			}
		});
		...
		soConfigButton.addSelectionListener(new ButtonListenerAdapter() {
			...
			public void pressed(SWTSkinButtonUtility buttonUtility,
				...
				mdi.showEntryByID(MultipleDocumentInterface.SIDEBAR_SECTION_CONFIG,
						PluginAir.CONFIG_SECTION_ID);
			}
		});

		PluginAir.instance.checker.addListener(this);

		return null;
	}

	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_Air.CheckerListener#portCheckStatusChanged(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_Air.CheckerListener#protocolAddressesStatusChanged(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_Air.CheckerListener#portCheckStart()
	 */
