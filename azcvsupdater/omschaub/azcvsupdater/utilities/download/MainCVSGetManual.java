...
public class MainCVSGetManual extends DownloadImp{
    ...
    public void failedCommands(){
        ...
        StatusBoxUtils.mainStatusAdd(" Torrent download failed.. Consider using the alternative HTTP download available from the manual download button",2);
