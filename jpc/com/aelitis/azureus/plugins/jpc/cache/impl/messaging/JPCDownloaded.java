 ...
 *
 */
public class JPCDownloaded implements JPCCacheMessage {
  ...
  public JPCDownloaded( int session_id, byte[] infohash, int piece_number, int piece_offset, int length ) {
  ...
  public String getID() {  return JPCCacheMessage.ID_JPC_DOWNLOADED;  }
  ...
  public Message create( ByteBuffer data ) throws MessageException {
    ...
    return new JPCDownloaded( id, hash, number, offset, length );
  }
