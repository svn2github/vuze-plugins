...
public class JPCHelloUp implements JPCCacheMessage {
  ...
  public JPCHelloUp( String client_id ) {    
    description = getID()+ " from " +client_id;    
    buffer = ByteBuffer.wrap( client_id.getBytes() );
  }
  
  
  public String getID() {  return JPCCacheMessage.ID_JPC_HELLO_UP;  }
  ...
  public Message create( ByteBuffer data ) throws MessageException {    
    ...
    return new JPCHelloUp( new String( client ) );
  }
