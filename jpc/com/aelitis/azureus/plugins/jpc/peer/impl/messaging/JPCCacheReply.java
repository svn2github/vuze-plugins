 ...
 *
 */
public class JPCCacheReply implements JPCPeerMessage {
  private final String description;
  private final ByteBuffer buffer;
  private final int session_id;
  
  
  public JPCCacheReply( int session_id ) {    
    this.session_id = session_id;
    description = getID()+ " using session id# " +session_id;
  ...
  public String getID() {  return JPCPeerMessage.ID_JPC_CACHE_REPLY;  }
