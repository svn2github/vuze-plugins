...
public interface PeerController {
  ...
  /**
   * Start JPC cache inter-client handling.
   */
  public void startPeerProcessing();
  
  /**
   * Stop JPC cache inter-client handling.
   */
  public void stopPeerProcessing();
  
  
  /**
   * Attempt to connect to the local download cache server.
   */
  public void establishDownloadCacheSession();
  
  /**
   * Drop the connection with the local download cache server.
   */
