...
hoverIn(this,transMenuSettings.subDelay);};var hoverIn=function(li,delay){if($(li).is('.separator')) return;var n=li.parentNode.firstChild;for(;n;n=n.nextSibling){if(n.nodeType==1&&n.nodeName.toUpperCase()=='LI'){var div=getOneChild(n,'DIV');if(div&&div.timer&&!div.isVisible){clearTimeout(div.timer);div.timer=null;}}}
