	...
	implements CheckerPPListener
{
	...
	public Object skinObjectInitialShow(SWTSkinObject skinObject, Object params) {
			...
			public void pressed(SWTSkinButtonUtility buttonUtility,
				...
				Utils.getOffOfSWTThread(new AERunnable() {
					...
					public void runSupport() {
						PluginPP.instance.checkerPP.calcProtocolAddresses();
		...
		soPFButton.addSelectionListener(new ButtonListenerAdapter() {
			...
			public void pressed(SWTSkinButtonUtility buttonUtility,
				...
				Utils.getOffOfSWTThread(new AERunnable() {
					@Override
					public void runSupport() {
						PluginPP.instance.checkerPP.portBindingCheck();
					}
				});
			}
		});
		...
		PluginPP.instance.checkerPP.addListener(this);

		return null;
	}

	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_PP.CheckerPPListener#portCheckStatusChanged(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_PP.CheckerPPListener#protocolAddressesStatusChanged(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vuze.plugin.azVPN_PP.CheckerPPListener#portCheckStart()
	 */
