...
public class RemoteMethodInvoker {
    ...
    private RemoteMethodInvoker(LoggerChannel log_channel) {
        this.log_channel = log_channel;
    }

    public static RemoteMethodInvoker create(LoggerChannel log_channel) {

        synchronized (instances) {
            RemoteMethodInvoker result = (RemoteMethodInvoker)instances.get(log_channel);
            if (result==null) {
                result = new RemoteMethodInvoker(log_channel);
    ...
    public RPReply process(Object o, org.gudy.azureus2.pluginsimpl.remote.RPRequest r) {
